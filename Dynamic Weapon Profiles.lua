...
re.on_draw_ui(function()
  ...
  if imgui.tree_node("DWP Profile Editing") then 
    ...
    if imgui.button("Add Profile") and new_profile_name ~= nil and new_profile_name ~= '' then
      local count = 1
      for _ in pairs(Weapon_Vars.Weapon_Profiles) do count = count + 1 end
...
re.on_frame(function()
  ...
  if show_profile_editor then
    ...
    if (currentAWFWeapon.WPtype == "HG") or (currentAWFWeapon.WPtype == "SMG") or (currentAWFWeapon.WPtype == "SR") or (currentAWFWeapon.WPtype == "SR_PUMP") or (currentAWFWeapon.WPtype == "MAG") or (currentAWFWeapon.WPtype == "MAG_SEMI")   then
    ...
    imgui.tree_pop()
      ...
      -- POWER EX
    if currentAWFWeapon.name == "RED9" or currentAWFWeapon.name == "BT" or currentAWFWeapon.name == "BRB" or currentAWFWeapon.name == "BM4" or currentAWFWeapon.name == "TMP" or currentAWFWeapon.name == "M1G" or currentAWFWeapon.name == "CQBR" then
