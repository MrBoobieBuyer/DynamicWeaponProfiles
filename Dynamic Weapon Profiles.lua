...
local function draw_profile_editor_ui()
  ...
  if imgui.tree_node("General") then
    -- ItemSize
    ItemSizeChanged, updatedItemSize = imgui.input_text("ItemSize", currentWeapon.ItemSize, 1)
    ...
    -- AmmoType
    AmmoTypeChanged, updatedAmmoType = imgui.input_text("Ammo Type", currentWeapon.AmmoType, 1)
    ...
    -- ReticleType
    ReticleTypeChanged, updatedReticleType = imgui.input_text("Reticle Type", currentWeapon.ReticleType, 1)
  ...
  if (currentAWFWeapon.WPtype == "HG") or (currentAWFWeapon.WPtype == "SMG") or (currentAWFWeapon.WPtype == "SR") or (currentAWFWeapon.WPtype == "SR_PUMP") or
    ...
    if imgui.tree_node("HG General") then
      -- HG_Distance 
      HG_DistanceChanged, updatedHG_Distance = imgui.input_text("HG Distance", currentWeapon.HG_Distance, 1)
      ...
      -- SMG_Random
      SMG_RandomChanged, updatedSMG_Random = imgui.input_text("SMG Random", currentWeapon.SMG_Random, 1)
      ...
      -- SMG_RandomFit
      SMG_RandomFitChanged, updatedSMG_RandomFit = imgui.input_text("SMG Random Fit", currentWeapon.SMG_RandomFit, 1)
      ...
      -- HG_CritRate
      HG_CritRateChanged, updatedHG_CritRate = imgui.input_text("HG Crit Rate", currentWeapon.HG_CritRate, 1)
      ...
      -- HG_CritRateEX
      HG_CritRateEXChanged, updatedHG_CritRateEX = imgui.input_text("HG Crit Rate EX", currentWeapon.HG_CritRateEX, 1)
    ...
    if imgui.tree_node("Focus") then
      -- Focus_HoldAdd
      Focus_HoldAddChanged, updatedFocus_HoldAdd = imgui.input_text("Focus Hold Add", currentWeapon.Focus_HoldAdd, 1)
      ...
      -- Focus_MoveSub
      Focus_MoveSubChanged, updatedFocus_MoveSub = imgui.input_text("Focus Move Sub", currentWeapon.Focus_MoveSub, 1)
      ...
      -- Focus_CamSub
      Focus_CamSubChanged, updatedFocus_CamSub = imgui.input_text("Focus Cam Sub", currentWeapon.Focus_CamSub, 1)
      ...
      -- Focus_Limit
      Focus_LimitChanged, updatedFocus_Limit = imgui.input_text("Focus Limit", currentWeapon.Focus_Limit, 1)
      if Focus_LimitChanged then
        currentWeapon.Focus_Limit = tonumber(updatedFocus_Limit)
        currentWeapon.Changed = true
      end
      -- Focus_ShootSub
      Focus_ShootSubChanged, updatedFocus_ShootSub = imgui.input_text("Focus Shoot Sub", currentWeapon.Focus_ShootSub, 1)
    ...
    if imgui.tree_node("Recoil") then
      -- Recoil_YawMin
      Recoil_YawMinChanged, updatedRecoil_YawMin = imgui.input_text("Recoil Yaw Min", currentWeapon.Recoil_YawMin, 1)
      ...
      -- Recoil_YawMax
      Recoil_YawMaxChanged, updatedRecoil_YawMax = imgui.input_text("Recoil Yaw Max", currentWeapon.Recoil_YawMax, 1)
      ...
      -- Recoil_PitchMin
      Recoil_PitchMinChanged, updatedRecoil_PitchMin = imgui.input_text("Recoil Pitch Min", currentWeapon.Recoil_PitchMin, 1)
      ...
      -- Recoil_PitchMax
      Recoil_PitchMaxChanged, updatedRecoil_PitchMax = imgui.input_text("Recoil Pitch Max", currentWeapon.Recoil_PitchMax, 1)
  ...
  if (currentAWFWeapon.WPtype == "SG") or (currentAWFWeapon.WPtype == "SG_PUMP") then
    if imgui.tree_node("Center Pellet Settings") then
      ...
      SG_CenterLife_DistanceChanged, updatedSG_CenterLife_Distance = imgui.input_text("SG Center Life Distance", currentWeapon.SG_CenterLife_Distance, 1)
      ...
      -- SG_CenterMove_Speed
      SG_CenterMove_SpeedChanged, updatedSG_CenterMove_Speed = imgui.input_text("SG Center Move Speed", currentWeapon.SG_CenterMove_Speed, 1)
      ...
      -- SG_CenterMove_IGD
      SG_CenterMove_IGDChanged, updatedSG_CenterMove_IGD = imgui.input_text("SG Center Move IGD", currentWeapon.SG_CenterMove_IGD, 1)
      ...
      -- SG_Center_BulletCol
      SG_Center_BulletColChanged, updatedSG_Center_BulletCol = imgui.input_text("SG Center Bullet Col", currentWeapon.SG_Center_BulletCol, 1)
      ...
      -- SG_Center_Random
      SG_Center_RandomChanged, updatedSG_Center_Random = imgui.input_text("SG Center Random", currentWeapon.SG_Center_Random, 1)
      ...
      -- SG_Center_RandomFit
      SG_Center_RandomFitChanged, updatedSG_Center_RandomFit = imgui.input_text("SG Center Random Fit", currentWeapon.SG_Center_RandomFit, 1)
      ...
      -- SG_Center_CritRate
      SG_Center_CritRateChanged, updatedSG_Center_CritRate = imgui.input_text("SG Center Crit Rate", currentWeapon.SG_Center_CritRate, 1)
      ...
      SG_Center_CritRate_EXChanged, updatedSG_Center_CritRate_EX = imgui.input_text("SG Center Crit Rate EX", currentWeapon.SG_Center_CritRate_EX, 1)
      ...
      -- SG_Center_BaseDMG
      SG_Center_BaseDMGChanged, updatedSG_Center_BaseDMG = imgui.input_text("SG Center Base DMG", currentWeapon.SG_Center_BaseDMG, 1)
      ...
      -- SG_Center_BaseWINC
      SG_Center_BaseWINCChanged, updatedSG_Center_BaseWINC = imgui.input_text("SG Center Base WINC", currentWeapon.SG_Center_BaseWINC, 1)
      ...
      -- SG_Center_BaseBRK
      SG_Center_BaseBRKChanged, updatedSG_Center_BaseBRK = imgui.input_text("SG Center Base BRK", currentWeapon.SG_Center_BaseBRK, 1)
      ...
      -- SG_Center_BaseSTOP
      SG_Center_BaseSTOPChanged, updatedSG_Center_BaseSTOP = imgui.input_text("SG Center Base STOP", currentWeapon.SG_Center_BaseSTOP, 1)
    ...
    if imgui.tree_node("Around Pellet Settings") then
      ...
      SG_AroundLife_DistanceChanged, updatedSG_AroundLife_Distance = imgui.input_text("SG Around Life Distance", currentWeapon.SG_AroundLife_Distance, 1)
      ...
      -- SG_AroundMove_Speed
      SG_AroundMove_SpeedChanged, updatedSG_AroundMove_Speed = imgui.input_text("SG Around Move Speed", currentWeapon.SG_AroundMove_Speed, 1)
      ...
      -- SG_AroundMove_IGD
      SG_AroundMove_IGDChanged, updatedSG_AroundMove_IGD = imgui.input_text("SG Around Move IGD", currentWeapon.SG_AroundMove_IGD, 1)
      ...
      -- SG_Around_BulletCol
      SG_Around_BulletColChanged, updatedSG_Around_BulletCol = imgui.input_text("SG Around Bullet Col", currentWeapon.SG_Around_BulletCol, 1)
      ...
      -- SG_Around_Random
      SG_Around_RandomChanged, updatedSG_Around_Random = imgui.input_text("SG Around Random", currentWeapon.SG_Around_Random, 1)
      ...
      -- SG_Around_RandomFit
      SG_Around_RandomFitChanged, updatedSG_Around_RandomFit = imgui.input_text("SG Around Random Fit", currentWeapon.SG_Around_RandomFit, 1)
      ...
      -- SG_Around_CritRate
      SG_Around_CritRateChanged, updatedSG_Around_CritRate = imgui.input_text("SG Around Crit Rate", currentWeapon.SG_Around_CritRate, 1)
      ...
      SG_Around_CritRate_EXChanged, updatedSG_Around_CritRate_EX = imgui.input_text("SG Around Crit Rate EX", currentWeapon.SG_Around_CritRate_EX, 1)
      ...
      -- SG_Around_BaseDMG
      SG_Around_BaseDMGChanged, updatedSG_Around_BaseDMG = imgui.input_text("SG Around Base DMG", currentWeapon.SG_Around_BaseDMG, 1)
      ...
      -- SG_Around_BaseWINC
      SG_Around_BaseWINCChanged, updatedSG_Around_BaseWINC = imgui.input_text("SG Around Base WINC", currentWeapon.SG_Around_BaseWINC, 1)
      ...
      -- SG_Around_BaseBRK
      SG_Around_BaseBRKChanged, updatedSG_Around_BaseBRK = imgui.input_text("SG Around Base BRK", currentWeapon.SG_Around_BaseBRK, 1)
      ...
      -- SG_Around_BaseSTOP
      SG_Around_BaseSTOPChanged, updatedSG_Around_BaseSTOP = imgui.input_text("SG Around Base STOP", currentWeapon.SG_Around_BaseSTOP, 1)
      ...
      SG_AroundBulletCountChanged, updatedSG_AroundBulletCount = imgui.input_text("SG Around Bullet Count", currentWeapon.SG_AroundBulletCount, 1)
      ...
      SG_CenterBulletCountChanged, updatedSG_CenterBulletCount = imgui.input_text("SG Center Bullet Count", currentWeapon.SG_CenterBulletCount, 1)
      ...
      -- SG_InnerRadius
      SG_InnerRadiusChanged, updatedSG_InnerRadius = imgui.input_text("SG Inner Radius", currentWeapon.SG_InnerRadius, 1)
      ...
      -- SG_OuterRadius
      SG_OuterRadiusChanged, updatedSG_OuterRadius = imgui.input_text("SG Outer Radius", currentWeapon.SG_OuterRadius, 1)
      ...
      -- SG_AroundVertMin
      SG_AroundVertMinChanged, updatedSG_AroundVertMin = imgui.input_text("SG Around Vert Min", currentWeapon.SG_AroundVertMin, 1)
      ...
      -- SG_AroundVertMax
      SG_AroundVertMaxChanged, updatedSG_AroundVertMax = imgui.input_text("SG Around Vert Max", currentWeapon.SG_AroundVertMax, 1)
      ...
      -- SG_AroundHorMin
      SG_AroundHorMinChanged, updatedSG_AroundHorMin = imgui.input_text("SG Around Hor Min", currentWeapon.SG_AroundHorMin, 1)
      ...
      -- SG_AroundHorMax
      SG_AroundHorMaxChanged, updatedSG_AroundHorMax = imgui.input_text("SG Around Hor Max", currentWeapon.SG_AroundHorMax, 1)
  ...
  if imgui.tree_node("Damage") then
    -- HG_BaseDMG
    HG_BaseDMGChanged, updatedHG_BaseDMG = imgui.input_text("HG Base DMG", currentWeapon.HG_BaseDMG, 1)
    ...
    -- DMG_LVL_01_INFO
    DMG_LVL_01_INFOChanged, updatedDMG_LVL_01_INFO = imgui.input_text("DMG LVL 01 Info", currentWeapon.DMG_LVL_01_INFO, 0)
    ...
    -- DMG_LVL_02
    DMG_LVL_02Changed, updatedDMG_LVL_02 = imgui.input_text("DMG LVL 02", currentWeapon.DMG_LVL_02, 1)
    ...
    -- DMG_LVL_02_INFO
    DMG_LVL_02_INFOChanged, updatedDMG_LVL_02_INFO = imgui.input_text("DMG LVL 02 Info", currentWeapon.DMG_LVL_02_INFO, 0)
    ...
    -- DMG_LVL_02_COST
    DMG_LVL_02_COSTChanged, updatedDMG_LVL_02_COST = imgui.input_text("DMG LVL 02 Cost", currentWeapon.DMG_LVL_02_COST, 1)
    ...
    -- DMG_LVL_03
    DMG_LVL_03Changed, updatedDMG_LVL_03 = imgui.input_text("DMG LVL 03", currentWeapon.DMG_LVL_03, 1)
    ...
    -- DMG_LVL_03_INFO
    DMG_LVL_03_INFOChanged, updatedDMG_LVL_03_INFO = imgui.input_text("DMG LVL 03 Info", currentWeapon.DMG_LVL_03_INFO, 0)
    ...
    -- DMG_LVL_03_COST
    DMG_LVL_03_COSTChanged, updatedDMG_LVL_03_COST = imgui.input_text("DMG LVL 03 Cost", currentWeapon.DMG_LVL_03_COST, 1)
    ...
    -- DMG_LVL_04
    DMG_LVL_04Changed, updatedDMG_LVL_04 = imgui.input_text("DMG LVL 04", currentWeapon.DMG_LVL_04, 1)
    ...
    -- DMG_LVL_04_INFO
    DMG_LVL_04_INFOChanged, updatedDMG_LVL_04_INFO = imgui.input_text("DMG LVL 04 Info", currentWeapon.DMG_LVL_04_INFO, 0)
    ...
    -- DMG_LVL_04_COST
    DMG_LVL_04_COSTChanged, updatedDMG_LVL_04_COST = imgui.input_text("DMG LVL 04 Cost", currentWeapon.DMG_LVL_04_COST, 1)
    ...
    -- DMG_LVL_05
    DMG_LVL_05Changed, updatedDMG_LVL_05 = imgui.input_text("DMG LVL 05", currentWeapon.DMG_LVL_05, 1)
    ...
    -- DMG_LVL_05_INFO
    DMG_LVL_05_INFOChanged, updatedDMG_LVL_05_INFO = imgui.input_text("DMG LVL 05 Info", currentWeapon.DMG_LVL_05_INFO, 0)
    ...
    -- DMG_LVL_05_COST
    DMG_LVL_05_COSTChanged, updatedDMG_LVL_05_COST = imgui.input_text("DMG LVL 05 Cost", currentWeapon.DMG_LVL_05_COST, 1)
    ...
    if imgui.tree_node("Wince") then
      -- HG_BaseWINC
      HG_BaseWINCChanged, updatedHG_BaseWINC = imgui.input_text("HG Base WINC", currentWeapon.HG_BaseWINC, 1)
      if HG_BaseWINCChanged then
        currentWeapon.HG_BaseWINC = tonumber(updatedHG_BaseWINC)
        currentWeapon.Changed = true
      end
      -- WINC_LVL_01
      WINC_LVL_01Changed, updatedWINC_LVL_01 = imgui.input_text("WINC LVL 01", currentWeapon.WINC_LVL_01, 1)
      ...
      -- WINC_LVL_02
      WINC_LVL_02Changed, updatedWINC_LVL_02 = imgui.input_text("WINC LVL 02", currentWeapon.WINC_LVL_02, 1)
      ...
      -- WINC_LVL_03
      WINC_LVL_03Changed, updatedWINC_LVL_03 = imgui.input_text("WINC LVL 03", currentWeapon.WINC_LVL_03, 1)
      ...
      -- WINC_LVL_04
      WINC_LVL_04Changed, updatedWINC_LVL_04 = imgui.input_text("WINC LVL 04", currentWeapon.WINC_LVL_04, 1)
      ...
      -- WINC_LVL_05
      WINC_LVL_05Changed, updatedWINC_LVL_05 = imgui.input_text("WINC LVL 05", currentWeapon.WINC_LVL_05, 1)
    ...
    if imgui.tree_node("Break") then
      -- HG_BaseBRK
      HG_BaseBRKChanged, updatedHG_BaseBRK = imgui.input_text("HG Base BRK", currentWeapon.HG_BaseBRK, 1)
      if HG_BaseBRKChanged then
        currentWeapon.HG_BaseBRK = tonumber(updatedHG_BaseBRK)
        currentWeapon.Changed = true
      end
      -- BRK_LVL_01
      BRK_LVL_01Changed, updatedBRK_LVL_01 = imgui.input_text("BRK LVL 01", currentWeapon.BRK_LVL_01, 1)
      ...
      -- BRK_LVL_02
      BRK_LVL_02Changed, updatedBRK_LVL_02 = imgui.input_text("BRK LVL 02", currentWeapon.BRK_LVL_02, 1)
      ...
      -- BRK_LVL_03
      BRK_LVL_03Changed, updatedBRK_LVL_03 = imgui.input_text("BRK LVL 03", currentWeapon.BRK_LVL_03, 1)
      ...
      -- BRK_LVL_04
      BRK_LVL_04Changed, updatedBRK_LVL_04 = imgui.input_text("BRK LVL 04", currentWeapon.BRK_LVL_04, 1)
      ...
      -- BRK_LVL_05
      BRK_LVL_05Changed, updatedBRK_LVL_05 = imgui.input_text("BRK LVL 05", currentWeapon.BRK_LVL_05, 1)
    ...
    if imgui.tree_node("Stopping Power") then
      -- HG_BaseSTOP
      HG_BaseSTOPChanged, updatedHG_BaseSTOP = imgui.input_text("HG Base STOP", currentWeapon.HG_BaseSTOP, 1)
      ...
      -- STOP_LVL_01
      STOP_LVL_01Changed, updatedSTOP_LVL_01 = imgui.input_text("STOP LVL 01", currentWeapon.STOP_LVL_01, 1)
      ...
      -- STOP_LVL_02
      STOP_LVL_02Changed, updatedSTOP_LVL_02 = imgui.input_text("STOP LVL 02", currentWeapon.STOP_LVL_02, 1)
      ...
      -- STOP_LVL_03
      STOP_LVL_03Changed, updatedSTOP_LVL_03 = imgui.input_text("STOP LVL 03", currentWeapon.STOP_LVL_03, 1)
      ...
      -- STOP_LVL_04
      STOP_LVL_04Changed, updatedSTOP_LVL_04 = imgui.input_text("STOP LVL 04", currentWeapon.STOP_LVL_04, 1)
      ...
      -- STOP_LVL_05
      STOP_LVL_05Changed, updatedSTOP_LVL_05 = imgui.input_text("STOP LVL 05", currentWeapon.STOP_LVL_05, 1)
  ...
  if imgui.tree_node("Capacity") then
    -- BaseAmmoNum
    BaseAmmoNumChanged, updatedBaseAmmoNum = imgui.input_text("Base Ammo Num", currentWeapon.BaseAmmoNum, 1)
    ...
    -- BaseAmmoCost
    BaseAmmoCostChanged, updatedBaseAmmoCost = imgui.input_text("Base Ammo Cost", currentWeapon.BaseAmmoCost, 1)
    ...
    -- AMMO_LVL_01_INFO
    AMMO_LVL_01_INFOChanged, updatedAMMO_LVL_01_INFO = imgui.input_text("AMMO LVL 01 INFO", currentWeapon.AMMO_LVL_01_INFO, 0)
    ...
    -- AMMO_LVL_02
    AMMO_LVL_02Changed, updatedAMMO_LVL_02 = imgui.input_text("AMMO LVL 02", currentWeapon.AMMO_LVL_02, 1)
    ...
    -- AMMO_LVL_02_INFO
    AMMO_LVL_02_INFOChanged, updatedAMMO_LVL_02_INFO = imgui.input_text("AMMO LVL 02 INFO", currentWeapon.AMMO_LVL_02_INFO, 0)
    ...
    -- AMMO_LVL_02_COST
    AMMO_LVL_02_COSTChanged, updatedAMMO_LVL_02_COST = imgui.input_text("AMMO LVL 02 COST", currentWeapon.AMMO_LVL_02_COST, 1)
    ...
    -- AMMO_LVL_03
    AMMO_LVL_03Changed, updatedAMMO_LVL_03 = imgui.input_text("AMMO LVL 03", currentWeapon.AMMO_LVL_03, 1)
    ...
    -- AMMO_LVL_03_INFO
    AMMO_LVL_03_INFOChanged, updatedAMMO_LVL_03_INFO = imgui.input_text("AMMO LVL 03 INFO", currentWeapon.AMMO_LVL_03_INFO, 0)
    ...
    -- AMMO_LVL_03_COST
    AMMO_LVL_03_COSTChanged, updatedAMMO_LVL_03_COST = imgui.input_text("AMMO LVL 03 COST", currentWeapon.AMMO_LVL_03_COST, 1)
    ...
    -- AMMO_LVL_04
    AMMO_LVL_04Changed, updatedAMMO_LVL_04 = imgui.input_text("AMMO LVL 04", currentWeapon.AMMO_LVL_04, 1)
    ...
    -- AMMO_LVL_04_INFO
    AMMO_LVL_04_INFOChanged, updatedAMMO_LVL_04_INFO = imgui.input_text("AMMO LVL 04 INFO", currentWeapon.AMMO_LVL_04_INFO, 0)
    ...
    -- AMMO_LVL_04_COST
    AMMO_LVL_04_COSTChanged, updatedAMMO_LVL_04_COST = imgui.input_text("AMMO LVL 04 COST", currentWeapon.AMMO_LVL_04_COST, 1)
    ...
    -- AMMO_LVL_05
    AMMO_LVL_05Changed, updatedAMMO_LVL_05 = imgui.input_text("AMMO LVL 05", currentWeapon.AMMO_LVL_05, 1)
    ...
    -- AMMO_LVL_05_INFO
    AMMO_LVL_05_INFOChanged, updatedAMMO_LVL_05_INFO = imgui.input_text("AMMO LVL 05 INFO", currentWeapon.AMMO_LVL_05_INFO, 0)
    ...
    -- AMMO_LVL_05_COST
    AMMO_LVL_05_COSTChanged, updatedAMMO_LVL_05_COST = imgui.input_text("AMMO LVL 05 COST", currentWeapon.AMMO_LVL_05_COST, 1)
  ...
  if imgui.tree_node("Reload Speed") then
    -- ReloadType
    ReloadTypeChanged, updatedReloadType = imgui.input_text("Reload Type", currentWeapon.ReloadType, 1)
    ...
    -- ReloadNum
    ReloadNumChanged, updatedReloadNum = imgui.input_text("Reload Num", currentWeapon.ReloadNum, 1)
    ...
    -- ReloadSpeedRate
    ReloadSpeedRateChanged, updatedReloadSpeedRate = imgui.input_text("Reload Speed Rate", currentWeapon.ReloadSpeedRate, 1)
    ...
    -- RELOAD_LVL_01
    RELOAD_LVL_01Changed, updatedRELOAD_LVL_01 = imgui.input_text("RELOAD LVL 01", currentWeapon.RELOAD_LVL_01, 1)
    ...
    -- RELOAD_LVL_01_INFO
    RELOAD_LVL_01_INFOChanged, updatedRELOAD_LVL_01_INFO = imgui.input_text("RELOAD LVL 01 INFO", currentWeapon.RELOAD_LVL_01_INFO, 0)
    ...
    -- RELOAD_LVL_01_COST
    RELOAD_LVL_01_COSTChanged, updatedRELOAD_LVL_01_COST = imgui.input_text("RELOAD LVL 01 COST", currentWeapon.RELOAD_LVL_01_COST, 1)
    ...
    -- RELOAD_LVL_02
    RELOAD_LVL_02Changed, updatedRELOAD_LVL_02 = imgui.input_text("RELOAD LVL 02", currentWeapon.RELOAD_LVL_02, 1)
    ...
    -- RELOAD_LVL_02_INFO
    RELOAD_LVL_02_INFOChanged, updatedRELOAD_LVL_02_INFO = imgui.input_text("RELOAD LVL 02 INFO", currentWeapon.RELOAD_LVL_02_INFO, 0)
    ...
    -- RELOAD_LVL_02_COST
    RELOAD_LVL_02_COSTChanged, updatedRELOAD_LVL_02_COST = imgui.input_text("RELOAD LVL 02 COST", currentWeapon.RELOAD_LVL_02_COST, 1)
    ...
    -- RELOAD_LVL_03
    RELOAD_LVL_03Changed, updatedRELOAD_LVL_03 = imgui.input_text("RELOAD LVL 03", currentWeapon.RELOAD_LVL_03, 1)
    ...
    -- RELOAD_LVL_03_INFO
    RELOAD_LVL_03_INFOChanged, updatedRELOAD_LVL_03_INFO = imgui.input_text("RELOAD LVL 03 INFO", currentWeapon.RELOAD_LVL_03_INFO, 0)
    ...
    -- RELOAD_LVL_03_COST
    RELOAD_LVL_03_COSTChanged, updatedRELOAD_LVL_03_COST = imgui.input_text("RELOAD LVL 03 COST", currentWeapon.RELOAD_LVL_03_COST, 1)
    ...
    -- RELOAD_LVL_04
    RELOAD_LVL_04Changed, updatedRELOAD_LVL_04 = imgui.input_text("RELOAD LVL 04", currentWeapon.RELOAD_LVL_04, 1)
    ...
    -- RELOAD_LVL_04_INFO
    RELOAD_LVL_04_INFOChanged, updatedRELOAD_LVL_04_INFO = imgui.input_text("RELOAD LVL 04 INFO", currentWeapon.RELOAD_LVL_04_INFO, 0)
    ...
    -- RELOAD_LVL_04_COST
    RELOAD_LVL_04_COSTChanged, updatedRELOAD_LVL_04_COST = imgui.input_text("RELOAD LVL 04 COST", currentWeapon.RELOAD_LVL_04_COST, 1)
    ...
    -- RELOAD_LVL_05
    RELOAD_LVL_05Changed, updatedRELOAD_LVL_05 = imgui.input_text("RELOAD LVL 05", currentWeapon.RELOAD_LVL_05, 1)
    ...
    -- RELOAD_LVL_05_INFO
    RELOAD_LVL_05_INFOChanged, updatedRELOAD_LVL_05_INFO = imgui.input_text("RELOAD LVL 05 INFO", currentWeapon.RELOAD_LVL_05_INFO, 0)
    ...
    -- RELOAD_LVL_05_COST
    RELOAD_LVL_05_COSTChanged, updatedRELOAD_LVL_05_COST = imgui.input_text("RELOAD LVL 05 COST", currentWeapon.RELOAD_LVL_05_COST, 1)
  ...
  if imgui.tree_node("Rate of Fire") then
    -- ShootType
    ShootTypeChanged, updatedShootType = imgui.input_text("Shoot Type", currentWeapon.ShootType, 1)
    ...
    -- PumpActionFireRate
    PumpActionFireRateChanged, updatedPumpActionFireRate = imgui.input_text("Pump Action Fire Rate", currentWeapon.PumpActionFireRate, 1)
    ...
    -- FireRate
    FireRateChanged, updatedFireRate = imgui.input_text("Fire Rate", currentWeapon.FireRate, 1)
    ...
    -- FireRateFrame
    FireRateFrameChanged, updatedFireRateFrame = imgui.input_text("Fire Rate Frame", currentWeapon.FireRateFrame, 1)
    ...
    -- ROF_LVL_01
    ROF_LVL_01Changed, updatedROF_LVL_01 = imgui.input_text("ROF LVL 01", currentWeapon.ROF_LVL_01, 1)
    ...
    -- ROF_LVL_01_INFO
    ROF_LVL_01_INFOChanged, updatedROF_LVL_01_INFO = imgui.input_text("ROF LVL 01 INFO", currentWeapon.ROF_LVL_01_INFO, 0)
    ...
    -- ROF_LVL_01_COST
    ROF_LVL_01_COSTChanged, updatedROF_LVL_01_COST = imgui.input_text("ROF LVL 01 COST", currentWeapon.ROF_LVL_01_COST, 1)
    ...
    -- ROF_LVL_02
    ROF_LVL_02Changed, updatedROF_LVL_02 = imgui.input_text("ROF LVL 02", currentWeapon.ROF_LVL_02, 1)
    ...
    -- ROF_LVL_02_INFO
    ROF_LVL_02_INFOChanged, updatedROF_LVL_02_INFO = imgui.input_text("ROF LVL 02 INFO", currentWeapon.ROF_LVL_02_INFO, 0)
    ...
    -- ROF_LVL_02_COST
    ROF_LVL_02_COSTChanged, updatedROF_LVL_02_COST = imgui.input_text("ROF LVL 02 COST", currentWeapon.ROF_LVL_02_COST, 1)
    ...
    -- ROF_LVL_03
    ROF_LVL_03Changed, updatedROF_LVL_03 = imgui.input_text("ROF LVL 03", currentWeapon.ROF_LVL_03, 1)
    ...
    -- ROF_LVL_03_INFO
    ROF_LVL_03_INFOChanged, updatedROF_LVL_03_INFO = imgui.input_text("ROF LVL 03 INFO", currentWeapon.ROF_LVL_03_INFO, 0)
    ...
    -- ROF_LVL_03_COST
    ROF_LVL_03_COSTChanged, updatedROF_LVL_03_COST = imgui.input_text("ROF LVL 03 COST", currentWeapon.ROF_LVL_03_COST, 1)
    ...
    -- ROF_LVL_04
    ROF_LVL_04Changed, updatedROF_LVL_04 = imgui.input_text("ROF LVL 04", currentWeapon.ROF_LVL_04, 1)
    ...
    -- ROF_LVL_04_INFO
    ROF_LVL_04_INFOChanged, updatedROF_LVL_04_INFO = imgui.input_text("ROF LVL 04 INFO", currentWeapon.ROF_LVL_04_INFO, 0)
    ...
    -- ROF_LVL_04_COST
    ROF_LVL_04_COSTChanged, updatedROF_LVL_04_COST = imgui.input_text("ROF LVL 04 COST", currentWeapon.ROF_LVL_04_COST, 1)
    ...
    -- ROF_LVL_05
    ROF_LVL_05Changed, updatedROF_LVL_05 = imgui.input_text("ROF LVL 05", currentWeapon.ROF_LVL_05, 1)
    ...
    -- ROF_LVL_05_INFO
    ROF_LVL_05_INFOChanged, updatedROF_LVL_05_INFO = imgui.input_text("ROF LVL 05 INFO", currentWeapon.ROF_LVL_05_INFO, 0)
    ...
    -- ROF_LVL_05_COST
    ROF_LVL_05_COSTChanged, updatedROF_LVL_05_COST = imgui.input_text("ROF LVL 05 COST", currentWeapon.ROF_LVL_05_COST, 1)
  ...
  if currentAWFWeapon.name == "RED9" or currentAWFWeapon.name == "BT" or currentAWFWeapon.name == "BRB" or currentAWFWeapon.name == "BM4" or currentAWFWeapon.name == "TMP" or
    ...
    if imgui.tree_node("Exclusive") then
      -- EX_DMG
      EX_DMGChanged, updatedEX_DMG = imgui.input_text("EX_DMG", currentWeapon.EX_DMG, 1)
      ...
      -- EX_WINCE
      EX_WINCEChanged, updatedEX_WINCE = imgui.input_text("EX_WINCE", currentWeapon.EX_WINCE, 1)
      ...
      -- EX_BRK
      EX_BRKChanged, updatedEX_BRK = imgui.input_text("EX_BRK", currentWeapon.EX_BRK, 1)
      ...
      -- EX_STOP
      EX_STOPChanged, updatedEX_STOP = imgui.input_text("EX_STOP", currentWeapon.EX_STOP, 1)
      ...
      -- EX_COST
      EX_COSTChanged, updatedEX_COST = imgui.input_text("EX_COST", currentWeapon.EX_COST, 1)
  ...
  if currentAWFWeapon.name == "M870" or currentAWFWeapon.name == "SKUL" then
    if imgui.tree_node("Exclusive") then
      ...
      -- EX_SG_DMG
      EX_SG_DMGChanged, updatedEX_SG_DMG = imgui.input_text("EX_SG_DMG", currentWeapon.EX_SG_DMG, 1)
      ...
      -- EX_SG_WINCE
      EX_SG_WINCEChanged, updatedEX_SG_WINCE = imgui.input_text("EX_SG_WINCE", currentWeapon.EX_SG_WINCE, 1)
      ...
      -- EX_SG_BRK
      EX_SG_BRKChanged, updatedEX_SG_BRK = imgui.input_text("EX_SG_BRK", currentWeapon.EX_SG_BRK, 1)
      ...
      -- EX_SG_STOP
      EX_SG_STOPChanged, updatedEX_SG_STOP = imgui.input_text("EX_SG_STOP", currentWeapon.EX_SG_STOP, 1)
  ...
  if currentAWFWeapon.name == "SEN9" or currentAWFWeapon.name == "SG09R" or currentAWFWeapon.name == "KIL7" then
    if imgui.tree_node("Exclusive") then
      -- EX_CRIT
      EX_CRITChanged, updatedEX_CRIT = imgui.input_text("EX_CRIT", currentWeapon.EX_CRIT, 1)
      ...
      -- EX_CRIT_FIT
      EX_CRIT_FITChanged, updatedEX_CRIT_FIT = imgui.input_text("EX_CRIT_FIT", currentWeapon.EX_CRIT_FIT, 1)
  ...
  if currentAWFWeapon.name == "PUN" or currentAWFWeapon.name == "LE5" then
    if imgui.tree_node("Exclusive") then
      -- EX_PIRC
      EX_PIRCChanged, updatedEX_PIRC = imgui.input_text("EX_PIRC", currentWeapon.EX_PIRC, 1)
      ...
      -- EX_PIRC_FIT
      EX_PIRC_FITChanged, updatedEX_PIRC_FIT = imgui.input_text("EX_PIRC_FIT", currentWeapon.EX_PIRC_FIT, 1)
  ...
  if currentAWFWeapon.name == "VP70" then
    if imgui.tree_node("Exclusive") then
      -- EX_AMMO
      EX_AMMOChanged, updatedEX_AMMO = imgui.input_text("EX_AMMO", currentWeapon.EX_AMMO, 1)
  ...
  if currentAWFWeapon.name == "STKR" then
    if imgui.tree_node("Exclusive") then
      ...
      -- EX_SG_RELOAD
      EX_SG_RELOADChanged, updatedEX_SG_RELOAD = imgui.input_text("EX_SG_RELOAD", currentWeapon.EX_SG_RELOAD, 1)
  ...
  if currentAWFWeapon.name == "SAR" then
    if imgui.tree_node("Exclusive") then
      -- EX_ROF
      EX_ROFChanged, updatedEX_ROF = imgui.input_text("EX_ROF", currentWeapon.EX_ROF, 1)
